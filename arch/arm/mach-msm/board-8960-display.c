...
#else
#define MSM_FB_PRIM_BUF_SIZE (1920 * 1200 * 4 * 3) /* 4 bpp x 2 pages */
#endif
#else
#if defined(CONFIG_MACH_MSM8960_CHEETAH) || defined(CONFIG_MACH_MSM8960_STARQ)/* jgshin for wvga 24bpp */
#define MSM_FB_PRIM_BUF_SIZE (800 * 480 * 4 * 2) /* 4 bpp x 2 pages */
#elif defined(CONFIG_MACH_MSM8960_OSCAR)
#define MSM_FB_PRIM_BUF_SIZE (960 * 544 * 4 * 2) /* 4 bpp x 3 pages */
#elif defined (CONFIG_MACH_MSM8960_EF45K) || defined (CONFIG_MACH_MSM8960_EF47S) || defined (CONFIG_MACH_MSM8960_EF46L)||\
	  defined(CONFIG_MACH_MSM8960_VEGAPVW) || defined(CONFIG_MACH_MSM8960_VEGAPKDDI)
...
static struct gpiomux_setting gpio_generals[1] = {
    {
        .func = GPIOMUX_FUNC_GPIO, /*lcd backlight*/
        .drv = GPIOMUX_DRV_2MA,
        .pull = GPIOMUX_PULL_DOWN,
    },
};
#if (BOARD_VER >= WS20) 
static struct msm_gpiomux_config msm8960_starqbacklight_configs[] = {
    {
        .gpio = 89,
        .settings = {
...
void __init msm8960_init_fb(void)
{
	...
	msm_gpiomux_install(msm8960_starqbacklight_configs,
			ARRAY_SIZE(msm8960_starqbacklight_configs));
#endif
