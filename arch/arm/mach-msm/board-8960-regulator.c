...
//#include "../../../../pantech/include/BOARD_REV.h" // mirinae
...
VREG_CONSUMERS(L2) = {
	...
	REGULATOR_SUPPLY("mipi_csi_vdd",		"4-005a"),//"msm_camera_s5k4ecgx.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_MT9D113
	REGULATOR_SUPPLY("mipi_csi_vdd",		"4-007a"),//"msm_camera_mt9d113.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_MT9V113
	REGULATOR_SUPPLY("mipi_csi_vdd",		"4-0078"),//"msm_camera_mt9v113.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_S5K6AAFX13
	REGULATOR_SUPPLY("mipi_csi_vdd",		"4-005a"),//"msm_camera_s5k6aafx13.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_S5K3H2
	REGULATOR_SUPPLY("mipi_csi_vdd",	"4-006e"),//"msm_camera_s5k3h2.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_OV8820
	REGULATOR_SUPPLY("mipi_csi_vdd",	"4-006c"),//"msm_camera_ov8820.0"),
#endif
...
#ifdef CONFIG_PANTECH_CAMERA_MT9D113	
	REGULATOR_SUPPLY("cam_vdd",		"msm_camera_mt9d113.0"),
#endif	
};
VREG_CONSUMERS(L10) = {
...
#ifdef CONFIG_PANTECH_CAMERA_S5K4ECGX
	REGULATOR_SUPPLY("cam_vana",		"4-005a"),//"msm_camera_s5k4ecgx.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_MT9D113
	REGULATOR_SUPPLY("cam_vana",		"4-007a"),//"msm_camera_mt9d113.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_S5K6AAFX13
	REGULATOR_SUPPLY("cam_vana",		"4-005a"),//"msm_camera_s5k6aafx13.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_S5K3H2
	REGULATOR_SUPPLY("cam_vana",	"4-006e"),//"msm_camera_s5k3h2.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_OV8820
	REGULATOR_SUPPLY("cam_vana",	"4-006c"),//"msm_camera_ov8820.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_YACD5C1SBDBC
...
#ifdef CONFIG_PANTECH_CAMERA_S5K4ECGX
	REGULATOR_SUPPLY("cam_vdig",		"4-005a"),//"msm_camera_s5k4ecgx.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_S5K6AAFX13
	REGULATOR_SUPPLY("cam_vdig",		"4-005a"),//"msm_camera_s5k6aafx13.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_S5K3H2
	REGULATOR_SUPPLY("cam_vdig",	"4-006e"),//"msm_camera_s5k3h2.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_OV8820
	REGULATOR_SUPPLY("cam_vdig",	"4-006c"),//"msm_camera_ov8820.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_YACD5C1SBDBC
...
//	p11309 - disabble camera Vcc for Touch IC 
#if defined(CONFIG_MACH_MSM8960_RACERJ)
	REGULATOR_SUPPLY("8921_l16",		NULL),
#else	
	REGULATOR_SUPPLY("8921_l16",		NULL),
#ifdef CONFIG_PANTECH_CAMERA_S5K4ECGX
	REGULATOR_SUPPLY("cam_vaf",		"4-005a"),//"msm_camera_s5k4ecgx.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_S5K6AAFX13
	REGULATOR_SUPPLY("cam_vaf",		"4-005a"),//"msm_camera_s5k6aafx13.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_S5K3H2
	REGULATOR_SUPPLY("cam_vaf",	"4-006e"),//"msm_camera_s5k3h2.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_OV8820
	REGULATOR_SUPPLY("cam_vaf",	"4-006c"),//"msm_camera_ov8820.0"),
#endif
#ifndef CONFIG_PANTECH_CAMERA
...
#if defined(CONFIG_MACH_MSM8960_VEGAPVW) || defined(CONFIG_MACH_MSM8960_VEGAPKDDI)
...
VREG_CONSUMERS(L18) = {
	REGULATOR_SUPPLY("8921_l18",		NULL),
		...
		REGULATOR_SUPPLY("cam_vdd",		"4-005a"),//"msm_camera_s5k6aafx13.0"),
#endif	
};
VREG_CONSUMERS(L21) = {
...
#if !defined(CONFIG_MACH_MSM8960_CHEETAH) && !defined(CONFIG_MACH_MSM8960_OSCAR) && !defined(CONFIG_MACH_MSM8960_VEGAPVW) && !defined(CONFIG_MACH_MSM8960_VEGAPKDDI)
	REGULATOR_SUPPLY("dsi_vddio",		"mipi_dsi.1"),
#endif
...
#ifdef CONFIG_PANTECH_CAMERA_S5K6AAFX13
	REGULATOR_SUPPLY("cam_vio",		"4-005a"),//"msm_camera_s5k6aafx13.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_MT9D113
	REGULATOR_SUPPLY("cam_vio",		"4-007a"),//"msm_camera_mt9d113.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_MT9V113
	REGULATOR_SUPPLY("cam_vio",		"4-0078"),//"msm_camera_mt9v113.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_S5K3H2
	REGULATOR_SUPPLY("cam_vio",	"4-006e"),//"msm_camera_s5k3h2.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_OV8820
	REGULATOR_SUPPLY("cam_vio",	"4-006c"),//"msm_camera_ov8820.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_YACD5C1SBDBC
...
#ifdef CONFIG_PANTECH_CAMERA_S5K4ECGX
	REGULATOR_SUPPLY("cam_iovdd",		"4-005a"),//"msm_camera_s5k4ecgx.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_MT9D113
	REGULATOR_SUPPLY("cam_iovdd",		"4-007a"),//"msm_camera_mt9d113.0"),
#endif
#ifdef CONFIG_PANTECH_CAMERA_S5K6AAFX13
	REGULATOR_SUPPLY("cam_iovdd",		"4-005a"),//"msm_camera_s5k6aafx13.0")
#endif
#ifdef CONFIG_PANTECH_CAMERA_YACD5C1SBDBC
...
msm_rpm_regulator_init_data[] __devinitdata = {
	...
	RPM_SMPS(S2,	 0, 1, 0, 1300000, 1300000, NULL, 0,	  2p13),
#else
...
#if defined(CONFIG_MACH_MSM8960_EF46L)
	RPM_SMPS(S8,	 1, 1, 1, 2200000, 2200000, NULL, 100000, 2p13),
#else
...
#if defined(CONFIG_MACH_MSM8960_CHEETAH) || defined(CONFIG_MACH_MSM8960_OSCAR)
...
#if 0//defined(CONFIG_PANTECH_CAMERA_YACD5C1SBDBC) && defined(CONFIG_MACH_MSM8960_EF46L)//defined (CONFIG_PANTECH_CAMERA_CE1612) || defined(CONFIG_PANTECH_CAMERA_MT9D113)
	...
	RPM_LDO(L11,	 0, 1, 0, 2800000, 2800000, NULL,      0, 0),
	 ...
	 defined (CONFIG_MACH_MSM8960_VEGAPVW) || defined (CONFIG_MACH_MSM8960_VEGAPKDDI)) && defined (CONFIG_PANTECH_FB_MSM_MHL_SII9244))
	RPM_LDO(L12,	 0, 1, 0, 1200000, 1200000, "8921_s4", 0, 0),
#else
	RPM_LDO(L12,	 0, 1, 0, 1500000, 1500000, "8921_s4", 0, 0),
#endif
	RPM_LDO(L14,	 0, 1, 0, 1800000, 1800000, NULL,      0, 0),
#if defined(CONFIG_MACH_MSM8960_CHEETAH) // mirinae_20110920 TOUCH
 #if (BOARD_VER == WS10)
...
#if defined(CONFIG_MACH_MSM8960_CHEETAH) // mirinae_20110920 UIM
 #if (BOARD_VER == WS10)
	RPM_LDO(L17,	 0, 1, 0, 3000000, 3000000, NULL,      0, 0),
 #else
	RPM_LDO(L17,	 0, 1, 0, 3300000, 3300000, NULL,      0, 0),
 #endif
#elif defined(CONFIG_MACH_MSM8960_VEGAPVW) || defined(CONFIG_MACH_MSM8960_VEGAPKDDI) /* mipi dsi1 VDD3 add by shinjaegon */
	...
	RPM_LDO(L17,	 0, 1, 0, 3300000, 3300000, NULL,      10000, 10000),/*high power mode 10000, 10000 */ /* low power mode 0,0 */
#else
	RPM_LDO(L17,	 0, 1, 0, 3300000, 3300000, NULL,      0, 0),
#endif 
#if defined(CONFIG_PANTECH_CAMERA_S5K6AAFX13) && defined(CONFIG_MACH_MSM8960_CHEETAH)
