...
#ifdef T_OSCAR	//20120615_Primia_Oscar_HI255_INIT_Mipi_AMOLED
#ifndef F_STREAM_ON_OFF	
{0x03, 0x00},
{0x01, 0x31}, //sleep on
#endif
...
static struct msm_camera_i2c_reg_conf yacd5c1sbdbc_cfg_reflect[][YACD5C1SBDBC_REFLECT_PARM] = {//[4][17]
    ...
    {//mirror "Flip X"
        {0x03, 0x00},
#ifdef F_PANTECH_CAMERA_2M_REG_TEST                
        {0x11, 0x91}, //B[2] Fixed Frame XY flip (90:Default)
#else
        {0x11, 0x81}, //B[2] Fixed Frame XY flip (90:Default)
#endif            
    },        
    {//water "Flip Y"
        {0x03, 0x00},
#ifdef F_PANTECH_CAMERA_2M_REG_TEST                
        {0x11, 0x92}, //B[2] Fixed Frame XY flip (90:Default)
#else
        {0x11, 0x82}, //B[2] Fixed Frame XY flip (90:Default)
#endif            
    },
...
#else
        {0x11, 0x83}, //B[2] Fixed Frame XY flip (90:Default)
#endif            
    },    
};
