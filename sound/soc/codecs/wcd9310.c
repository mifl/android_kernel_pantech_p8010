...
static int tabla_version_status = 0;
...
int wcd9310_tablaVersionStatusGet(void)
{
	return tabla_version_status;
}
#endif
...
#if defined(T_OSCAR)//by elecjang for fluence
...
#if 0 //defined(T_EF47S) || defined(T_EF45K) || defined(T_EF46L) //[LS1 CHD DB16] workaround code for headset remove interrupt
