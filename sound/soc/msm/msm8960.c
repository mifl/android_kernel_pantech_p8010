...
//-----------------------------------------------------------------//
// StarQ 			MSM GPIO 50			HW_REVISION   5 
// EF47S 		MSM GPIO 35			BOARD_VER_TP30
// EF45K 		MSM GPIO 35			BOARD_VER_TP30
// EF46L 			MSM GPIO 35			BOARD_VER_TP30
// OSCAR 		MSM GPIO 35			BOARD_VER_TP20	
// PREMIA V  		MSM GPIO 35?		BOARD_VER_TP20
// SIRIUS LTE 	MSM GPIO 35?		BOARD_VER_PT20
// MAGNUS	       PM 38			       BOARD_VER_WS20
// Sirius LTE          PM 38                          BOARD_VER_PT20
// EF44S               PM 38                          BOARD_VER_TP10
//-----------------------------------------------------------------//
...
#if defined(T_OSCAR)//20120126 By elecjang for WS10 Fluence
 #if (BOARD_VER > WS10)
...
#ifdef CONFIG_PANTECH_SND
static const struct snd_soc_dapm_route common_cs_audio_map[] = {
...
static int tabla_version_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	ucontrol->value.integer.value[0] = wcd9310_tablaVersionStatusGet();
	return 0;
}

static int tabla_version_set(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	pr_info("%s() %s\n", __func__, "This behaviour is not implemented");
	return 0;
}
...
static const struct snd_kcontrol_new tabla_msm8960_controls[] = {
	...
	SOC_ENUM_EXT("Headset Status", msm8960_enum[3], headset_status_get,
		headset_status_set),
	SOC_ENUM_EXT("Tabla Version", msm8960_enum[4], tabla_version_get,
		tabla_version_set),
#endif
#if defined(T_EF47S) || defined(T_EF45K) || defined(T_EF46L)
	SOC_ENUM_EXT("Autoans Flag", msm8960_enum[5], autoans_flag_get,
		autoans_flag_set),
#endif
};
